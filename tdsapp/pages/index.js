...
export default function Home({ theme }) {
  ...
  return (
    ...
    <Wrapper>
      <Header />
      <aside className=" bg-gray-300 dark:text-white dark:bg-gray-600 border-t  dark:border-gray-700 flex items-center justify-between font-secondary capitalize border-b">
        ...
        <button className="mx-3 my-1 pl-2 gap-2 bg-gray-200  dark:bg-gray-900 rounded dark:text-white  text-gray-900 flex items-center justify-center capitalize">
          login
          <svg
            xmlns="http://www.w3.org/2000/svg"
