  ...
  try {
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        ...
        pass: "chris2001",
        clientId:
          "904072759992-9a1rgosvbtm6c7sl98c22q6b9keou5vo.apps.googleusercontent.com",
        clientSecret: "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",
        refreshToken:
          "1//04w2C8P-P074vCgYIARAAGAQSNwF-L9Ir_ezmH2VUMf_OZTn4OGhbMU6-yUq9e2VcmfAYwi-9avr-Ro5vdYDjRaeFqsU2nLZtrQU",
      },
    });
    ...
    cron.schedule("* * * * *", () => {
      ...
      const filoImgSrc = [
        "https://i.guim.co.uk/img/media/c5a3cb22f4ae7b4a4c7462ef4d2d0c71cacb3c65/0_232_2789_1673/master/2789.jpg?width=940&quality=85&auto=format&fit=max&s=0b695db320a8e16753050aab4c0ed389",
        "https://www.ancienthistorylists.com/wp-content/uploads/2015/03/Greek-Philosopher-parmenides-1024x576.jpg",
        "https://miro.medium.com/max/1200/1*qYE-w8U1Oc5mE_1CRxlAbg.jpeg",
      ];
